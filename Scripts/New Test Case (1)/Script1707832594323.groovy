...
Mobile.tap(findTestObject('Object Repository/3 Filter/android.widget.ImageView (1)'), 0)

Mobile.tap(findTestObject('Object Repository/3 Filter/android.widget.LinearLayout (1)'), 0)

Mobile.tap(findTestObject('Object Repository/3 Filter/android.widget.ImageView (1)'), 0)

Mobile.tap(findTestObject('Object Repository/3 Filter/android.widget.LinearLayout (2)'), 0)
